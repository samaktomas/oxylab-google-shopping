  ...
  return (
    <header className="flex flex-col items-center md:flex-row md:items-start md:space-x-6 px-2 pt-10 pb-5 md:p-10 md:pb-5">
      ...
      <div className="w-full md:max-w-2xl">
        ...
        >
          <div className="flex items-center gap-2 w-full px-4">
            <div className="flex items-center gap-x-2 bg-white shadow-xl rounded-full border-0 px-6 py-4 md:max-w-5xl flex-1">
          ...
          <div className="grid grid-col-2 gap-2 p-4 md:grid-cols-4 max-w-lg md:max-w-none mx-auto items-center">
            <SearchSelect
      ...
      <div className="hidden lg:flex flex-1 justify-end">
        <Avatar name="Tomas Samak" round size="50" />
      </div>
    </header>
  );
}
